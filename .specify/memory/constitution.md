...
**Project:** opscale-co/nova-dynamic-resources
**Project Type:** package
**Module Prefix:** dynamic_resources
**Tenant Aware:** no
**Created:** 2026-05-01
...
This package is config-based rendering for Nova resources — horizontal infrastructure
that consuming applications wrap with their own multi-tenancy concerns. Tenant scoping
is the responsibility of the consuming app, not of this package.

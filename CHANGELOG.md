...
* chore(deps): update dependencies to latest compatible versions ([3924ffa](https://github.com/opscale-co/nova-dynamic-resources/commit/3924ffa))
...
* fix(usestemplate): solved wrong record shoing at index ([4b2c98a](https://github.com/opscale-co/nova-dynamic-resources/commit/4b2c98a))
...
* refactor(dynamicresource): changed fields definition ([f196c8b](https://github.com/opscale-co/nova-dynamic-resources/commit/f196c8b))
